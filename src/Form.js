                    ...
                    <Form layout="inline">
                        ...
                        >
                            {getFieldDecorator('img', {
                                ...
                                <Upload action={"http://link.cn/l3admin/file/upload"}
...
class CollectionsPage extends React.Component {
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if (values.img.field && values.img.file.response.path) {
                values.img = values.img.file.response.path;
            } else {
                values.img = '';
            }
            console.log('Received values of form: ', values);
            Axios.post('http://link.cn/l3admin/alert-config/post', values).then(() => {
                alert('添加成功');
